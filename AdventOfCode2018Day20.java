...
/*
 * Parse the input, take a character.
 * If the character '(', push the current location on the stack.
 * If the character ')', pop from the stack.
 * If the character '|', peek from the stack.
 * Keep rooms in an array and use path variable to know 
 * how many doors this room is from the original location.
 */
class Room {
	int x;
	int y;
	...
	public boolean equals(Object r) {
		return (x == ((Room)r).x && y == ((Room)r).y);
	}
}

public class AdventOfCode2018Day20 {
    ...
    public static void main(String args[]) {
        ...
        Room curr = new Room();
        while (true) {
        	Character c = regex.charAt(index);
        	if (c == 'N') curr.y++;
        	else if (c == 'E') curr.x++;
        	else if (c == 'S') curr.y--;
        	else if (c == 'W') curr.x--;
        	else if (c == '(') {
        		stack.push(new Room(curr.x, curr.y, curr.path));
        		index++;
        		continue;
        	}
        	else if (c == '|') {
        		curr = new Room(stack.peek().x, stack.peek().y, stack.peek().path);
        		index++;
        		continue;
        	}
        	else if (c == ')') {
        	...
        	Room r = new Room(curr.x, curr.y, ++curr.path);
        	if (!rooms.contains(r)) rooms.add(r);
        	index++;
        }
        
        // find a room with the longest shortest path
        Room answer1 = null;
